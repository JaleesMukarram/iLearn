...
import com.openlearning.ilearn.quiz.admin.activities.AddSubject;
import com.openlearning.ilearn.quiz.admin.activities.AllQuiz;
...
public class SubjectAdapter extends RecyclerView.Adapter<SubjectAdapter.NewsViewHolder> {
    ...
    class NewsViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final int position) {
            ...
            if (!subjectList.get(position).isActive()) {
