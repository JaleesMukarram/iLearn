...
import static com.openlearning.ilearn.quiz.repositories.SubjectRepository.SUBJECT_COLLECTION;
...
public class QuizRepository {
    ...
    public void insertNewQuiz(Quiz quiz, FirebaseSuccessListener listener) {
        ...
        db.collection(SUBJECT_COLLECTION)
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (!task.isSuccessful()) {
                        ...
                        Log.d(TAG, "insertNewQuizQuestion: failed to insert new Quiz: " + task.getException());
                        listener.onFailure(task.getException());
                        return;
                    }

                    listener.onSuccess(quiz);
                    Log.d(TAG, "insertNewQuizQuestion: Subject added successfully");
                });
    ...
    public void getQuizSectionFromDatabase(boolean fromServer, String subjectID, String quizID, FireStoreObjectGetListener listener) {

        if (!fromServer && quizSectionList != null && quizSectionList.size() > 0) {

            listener.onSuccess(quizSectionList);
            Log.d(TAG, "getQuizSectionFromDatabase: Old list returned");
            return;
        }
        ...
        db.collection(SUBJECT_COLLECTION)
                ...
                .addSnapshotListener((querySnapshot, error) -> {
                    ...
                    if (error != null) {
                        ...
                        Log.d(TAG, "getQuizSectionFromDatabase: Quiz getting failed");
                        listener.onFailure(error);
                        return;
                    }
                    assert quizSectionList != null;
                    ...
                    if (Objects.requireNonNull(querySnapshot).size() > 0) {
                        ...
                        Log.d(TAG, "getQuizSectionFromDatabase: No News found");
                        listener.onSuccess(null);
                    }
    ...
    public void getQuizSectionQuestionFromDatabase(boolean fromServer, Quiz quiz, String sectionID, FireStoreObjectGetListener listener) {
        ...
        db.collection(SUBJECT_COLLECTION)
                ...
                .addSnapshotListener((querySnapshot, error) -> {
                    ...
                    if (error != null) {
                        ...
                        Log.d(TAG, "getQuizSectionQuestionFromDatabase: Quiz getting failed");
                        listener.onFailure(error);
                        return;
                    }
                    ...
                    if (Objects.requireNonNull(querySnapshot).size() > 0) {
                        ...
                        Log.d(TAG, "getQuizSectionQuestionFromDatabase: No News found");
                        listener.onSuccess(null);
                    }
